...
const Update = () => {
    ...
    const { form, onSubmit } = useProductMutation({ action: "UPDATE" })
    useEffect(() => {
        form.reset(data)
    }, [id, form, data])
    return (
                ...
                <section className="update-products">
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        <div className="mb-3">
                            ...
                            {/* {errors.name && errors.name.type == 'required' && (<div id="emailHelp" className="form-text text-danger">Bạn cần nhập tên sản phẩm</div>)} */}
                        </div>
                        <div className="mb-3">
